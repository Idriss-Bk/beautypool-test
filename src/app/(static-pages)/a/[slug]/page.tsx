...
const Page = () => {
        ...
        try {
          ...
          if (articleData) {
            ...
            servicesResponse.data.data.sub_service.forEach((service: any) => {
              const parentServiceName = service.sub_services_id.parent_service.name;
              if (!parentServices[parentServiceName]) {
                parentServices[parentServiceName] = {
                  name: parentServiceName,
                  description: service.sub_services_id.parent_service.description,
                  sub_services: [],
                };
              }
  ...
  return (
          ...
          <div className="lg:flex">
            <div className="lg:w-8/12">
              <div>
                ...
                <Tab key={value} value={value} placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
                        {label}
                      </Tab>
                    ))}
                  </TabsHeader>
    ...
    onPointerLeaveCapture={() => {}}
  >
  {selectedService.parent_service.sub_services.map((subService, subIndex) => (
