...
const Page = () => {
  ...
  useEffect(() => {
    console.log("useEffect triggered with id:", id); // Debugging log
    const getArticle = async () => {
      const accessToken = Cookies.get("access_token"); // Retrieve the access token from cookies
      if (id && accessToken) {
        try {
          const response = await api.get(`/items/articles/${id}`, {
            headers: {
              Authorization: `Bearer ${accessToken}`,
            },
          });
  ...
  console.log("Rendering with id:", id); // Debugging log
      ...
      <div className="px-5 lg:px-12 relative top-28">
        ...
        <div className="mt-8 mb-16">
          <div className="lg:flex gap-8">
            <div className="lg:w-1/12">
              <div className="grid grid-cols-1 gap-4">
                ...
                <img
                  ...
                  className="w-full rounded-lg h-28 object-cover"
                />
                <button className="text-violet-500 text-sm font-semibold">See all Images</button>
              </div>
            </div>
            <div className="lg:w-7/12">
              <div className="md:col-span-2">
            ...
            <div className="lg:w-4/12">
              <div className="bg-white shadow-xl rounded-lg p-4 sticky top-28 flex flex-col">
                <h1 className="text-4xl font-bold">{article.label}</h1>
                <div className="flex items-center mt-2">
                  <span className="text-lg font-bold">5.0</span>
                  <span className="ml-1 text-yellow-500 flex justify-center items-center relative -top-[1px]">
                  ...
                  <a href="#" className="ml-2 text-violet-500">
                    (5,113)
                  </a>
                </div>
                <button className="mt-4 bg-black font-semibold text-white py-3.5 px-4 rounded-lg w-full">
                ...
                <div className="mt-6">
                  <div
                    ...
                    onClick={() => setIsOpen(!isOpen)}
                  >
                    <CiClock1 className="size-5 text-slate-800 -mr-0.5" />
                    <span className="ml-2">Open until 8:00PM</span>
                    <FaArrowDown
                      className={`fas fa-chevron-${
                        isOpen ? "up" : "down"
