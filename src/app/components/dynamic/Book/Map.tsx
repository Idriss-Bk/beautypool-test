        ...
        >
          {articles.map((article) => (
            ...
            >
              ...
              /> */}
              <div className="h-11 w-11 bg-cover bg-center" style={{ backgroundImage: `url(http://109.199.103.20:2022/assets/12247141-da04-4eb2-bff5-205417bc924b?cache-buster=2024-12-07T13:14:36.000Z&key=system-large-contain)` }}>
          ...
          {selected && (
            <Link href={`/a/${selected.slug}`}>
              ...
              >
                <div>
                  <img
                    src={`http://109.199.103.20:2022/assets/${selected.featured_image}`}
                    alt={selected.label}
                    className="mb-1"
                    style={{
                      width: "100%",
          ...
          {userLocation && (
            ...
            >
              {/* <img
                src="http://109.199.103.20:2022/assets/12247141-da04-4eb2-bff5-205417bc924b?cache-buster=2024-12-07T13:14:36.000Z&key=system-large-contain"
