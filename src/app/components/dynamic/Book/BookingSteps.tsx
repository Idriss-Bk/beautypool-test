...
import PaymentForm from "@/app/components/dynamic/Book/Booking/PaymentForm";
            ...
            <div className="flex-1">
              ...
              <div className="mt-16">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-slate-700 font-medium text-sm max-w-[700px]">
                    Please ensure you are aware of the service you're booking to
                    help with accurate timing. If you have any questions, feel
                    free to contact David, David, or myself.
                  </p>
                  <p className="text-slate-700 font-medium text-sm max-w-[700px]">
