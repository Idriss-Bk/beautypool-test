...
const Settings = () => {
  ...
  const handleUpdateProfile = async () => {
    setLoading(true);
    try {
      await axios.put("https://your-backend-endpoint.com/users/me", { name, dob }); // Update the profile
  ...
  const handleUpdateContact = async () => {
    setLoading(true);
    try {
      await axios.put("https://your-backend-endpoint.com/users/contact", { email, phone }); // Update contact details
    ...
    <>
      ...
      <div className="ml-0 lg:ml-64 p-5 xl:pt-32 xl:pl-14 overflow-auto bg-slate-100 h-screen">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8 max-w-xl">
          ...
          <div className="space-y-4">
            <div className="flex flex-col">
              <label htmlFor="name" className="font-semibold text-sm mb-2">Full Name</label>
              <input
                type="text"
                id="name"
                value={name}
            ...
            <div className="flex flex-col">
              <label htmlFor="dob" className="font-semibold text-sm mb-2">Date of Birth</label>
              <input
                type="date"
                id="dob"
                value={dob}
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8 max-w-xl">
          ...
          <div className="space-y-4">
            <div className="flex flex-col">
              <label htmlFor="email" className="font-semibold text-sm mb-2">Email Address</label>
              <input
                type="email"
                id="email"
                value={email}
            ...
            <div className="flex flex-col">
              <label htmlFor="phone" className="font-semibold text-sm mb-2">Phone Number</label>
              <input
                type="tel"
                id="phone"
                value={phone}
