...
import { IoLogInSharp, IoLogOutOutline, IoNotificationsOutline } from "react-icons/io5";
  ...
  return (
    <div className="relative top-0.5">
      <div className="flex justify-center items-center gap-3">
        <button className="mr-1"><IoNotificationsOutline className="size-7 text-black" /></button>
