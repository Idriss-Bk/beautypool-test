    ...
    <footer className="bg-gray-50 py-4 px-4 sm:py-6 md:py-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <div className="flex gap-4 text-black mt-2">
            {/* Social Media Icons */}
            <FaFacebookF
              className="text-xl cursor-pointer hover:text-[#f4b8ae] transition-all duration-200"
              aria-label="Facebook"
            />
            <FaTwitter
              className="text-xl cursor-pointer hover:text-[#f4b8ae] transition-all duration-200"
        ...
        <div className="text-center">
          <p className="text-gray-600 text-xs sm:text-sm">
            <a href="/privacy-policy" className="hover:underline transition-all duration-200">
              Privacy Policy
            </a>{" "}
            |{" "}
            <a href="/terms-of-service" className="hover:underline transition-all duration-200">
              Terms of Service
            </a>{" "}
            |{" "}
            <a href="/contact-us" className="hover:underline transition-all duration-200">
              Contact Us
            </a>
          </p>
        </div>
      ...
      <div className="max-w-5xl mx-auto">
        <div className="border-t border-gray-300 mt-4 pt-4 flex flex-col sm:flex-row justify-between items-center text-gray-600 text-xs sm:text-sm">
          ...
          <p className="mt-2 sm:mt-0 text-center">© 2024 BeautyPool. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
