...
export default function Achievement() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f4b9ae1a] text-center px-3 md:px-2 lg:px-2 xl:px-2 shadow-lg">
      <h1 className={`${gruppo.className} text-2xl sm:text-3xl md:text-4xl lg:text-7xl font-bold text-gray-950 mb-4 max-w-[1000px] mx-auto`}>
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-500 mb-8">
        Discover simplicity with BeautyPool – your trusted partner in wellness and beauty services.
      </p>
      <div className={`${gruppo.className} text-[#f4b8ae] font-extrabold text-5xl sm:text-6xl md:text-8xl mb-4`}>
        100K+
      </div>
